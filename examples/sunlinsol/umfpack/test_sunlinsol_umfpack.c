 ...
 * -----------------------------------------------------------------
 * -----------------------------------------------------------------
 * This is the testing routine to check the SUNLinSol UMFPACK module 
 * implementation. 
 * -----------------------------------------------------------------
 */
...
/* ----------------------------------------------------------------------
 * SUNLinSol_UMFPACK Linear Solver Testing Routine
 * --------------------------------------------------------------------*/
int main(int argc, char *argv[]) 
{
  ...
  printf("\nUMFPACK linear solver test: size %ld, type %i\n\n",
         (long int) N, mattype);
  ...
  printf("Creating linear solver\n");
   // Create UMFPACK linear solver 
  LS = SUNLinSol_UMFPACK(x, A);
  ...
  fails += Test_SUNLinSolGetID(LS, SUNLINEARSOLVER_UMFPACK, 0);
